        ...
        public async Task CanAddDoubleReferenceUsage()
        {
            ...
            try
            {
                ...
                using (var context = new ReferencesDbContext(options))
                {
                    var service = new ReferencesController(context, index);
                    await service.Post(new Reference() { Id = id, ReferenceUsage = new List<ReferenceUsage>() { new ReferenceUsage() { ApplicationId = 1, UserId = new Guid("3ed89222-de9a-4df3-9e95-67f7fcac67a3") }, new ReferenceUsage() { ApplicationId = 2, UserId = new Guid("3ed89222-de9a-4df3-9e95-67f7fcac67a3") } } }).ConfigureAwait(false);
                    await service.Post(new Reference() { Id = id2, ReferenceUsage = new List<ReferenceUsage>() { new ReferenceUsage() { ApplicationId = 1, UserId = new Guid("3ed89222-de9a-4df3-9e95-67f7fcac67a3") }, new ReferenceUsage() { ApplicationId = 2, UserId = new Guid("3ed89222-de9a-4df3-9e95-67f7fcac67a3") } } }).ConfigureAwait(false);
                }
                ...
                using (var context = new ReferencesDbContext(options))
                {
                    var service = new ReferencesController(context, index);
                    var usageService = new ReferenceUsageController(context);
                    await usageService.Post(new ReferenceUsage[]{new ReferenceUsage() { ApplicationId = 3, ReferenceId = id, UserId = new Guid("3ed89222-de9a-4df3-9e95-67f7fcac67a3") }, new ReferenceUsage() { ApplicationId = 3, ReferenceId = id2, UserId = new Guid("3ed89222-de9a-4df3-9e95-67f7fcac67a3") } }).ConfigureAwait(false);
                    var all = await usageService.GetAll(0, 10).ConfigureAwait(false);
